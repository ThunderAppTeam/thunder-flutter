...
class _$AuthStateImpl implements _AuthState {
  ...
  @override
  String toString() {
    return 'AuthState(status: $status, verificationId: $verificationId, smsCode: $smsCode, failureReason: $failureReason)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, status, verificationId, smsCode, failureReason);
...
abstract class _AuthState implements AuthState {
  const factory _AuthState(
      ...
      final String? verificationId,
      final String? smsCode,
      final AuthFailureReason? failureReason}) = _$AuthStateImpl;
